...
app.get("/variant/images/:id", (req, res) => {
  fetch(`https://mykabuto.myshopify.com/admin/api/2021-04/products/${req.params.id}/images.json`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      "X-Shopify-Access-Token": "a91336d9d661d607f5233bbbaf55b2c5",
...
app.get("/products/metafields/:id", (req, res) => {
  fetch(`https://mykabuto.myshopify.com/admin/api/2021-04/products/${req.params.id}/metafields.json`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      "X-Shopify-Access-Token": "a91336d9d661d607f5233bbbaf55b2c5",
